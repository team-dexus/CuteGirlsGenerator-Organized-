...
int meta_buf_10[] = {1037638,1035590,1037654,16,64,16,64,1015021568,841731191,1056964608,1045220557};
...
int meta_buf_18[] = {1096022,1087830,1096086,64,64,64,64,1015021568,841731191,1056964608,1045220557,1030839279};
...
int meta_buf_38[] = {1563350,1596118,1596374,256,64,256,64,1015021568,841731191,1056964608,1045220557};
...
int meta_buf_46[] = {2399190,2530262,2531286,1024,64,1024,64,1015021568,841731191,1056964608,1045220557,1030839279};
...
int meta_buf_52[] = {3252182,3383254,3384278,1024,64,1024,64,1015021568,841731191,1056964608,1045220557};
...
int meta_buf_60[] = {6595542,7119830,7123926,4096,64,4096,64,1015021568,841731191,1056964608,1045220557,1030839279};
...
int meta_buf_66[] = {10007510,10531798,10535894,4096,64,4096,64,1015021568,841731191,1056964608,1045220557};
...
int meta_buf_74[] = {23380950,25478102,25494486,16384,64,16384,64,1015021568,841731191,1056964608,1045220557,1030839279};
...
int meta_buf_82[] = {537536,537539,40190934,40240086,16384,3,3,3,16384,-1082130432,1};
...
int meta_buf_93[] = {793539,596931,793542,69911510,40485846,70108118,65536,65536,3,65536,3,3,65536,-1082130432,1,-1082130432,1};
...
void fusedelementwise_338173d234b201d7af689dd532f8ec1fd253e97fdbe0ed57c3745e5f(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
fusedelementwise_a539fc433f70acc39bfd392d237ee1ddac97fd280c5c3d0b7624788c(meta_buf_10);
...
fusedelementwise_577b0886dad6a4e0a445f105e7b36ed43f8f1f2b54b07c180cf81ab5(meta_buf_18);
...
fusedelementwise_e580eb60fff7d9c089fcc408082bcbc2ad574fe552e494230c0426c6(meta_buf_38);
...
fusedelementwise_bf2429aa06e03fb0cf3d7c16d8beb4a76a2eeaf9b7283978776beaf7(meta_buf_46);
...
fusedelementwise_e580eb60fff7d9c089fcc408082bcbc2ad574fe552e494230c0426c6(meta_buf_52);
...
fusedelementwise_bf2429aa06e03fb0cf3d7c16d8beb4a76a2eeaf9b7283978776beaf7(meta_buf_60);
...
fusedelementwise_e580eb60fff7d9c089fcc408082bcbc2ad574fe552e494230c0426c6(meta_buf_66);
...
fusedelementwise_bf2429aa06e03fb0cf3d7c16d8beb4a76a2eeaf9b7283978776beaf7(meta_buf_74);
...
fusedelementwise_338173d234b201d7af689dd532f8ec1fd253e97fdbe0ed57c3745e5f(meta_buf_93);
